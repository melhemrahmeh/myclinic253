    ...
    return (
        <>
            <section id="sidebar">
                ...
                <ul className="sideMenu top nav flex-column pmd-sidebar-nav">
                    <li className="active">
                        <a href="#">
                ...
                <ul className="sideMenu nav flex-column pmd-sidebar-nav">
                    <li>
                        <a href="#">
...
export default function Main() { 
    ...
    var myemployees = "../myemployees";
    var mypatients = "../mypatients";
    var schedule = "../schedule";
    var aftervisit = "../aftervisit";
    var profile = "../profile";
    var login = "../login";
